...
(function($) {
  ...
  function encodeDocId(docID) {
    //console.log("$.couch.js --- encodeDocId");
  ...
  $.extend($.couch, {
    ...
    //console.log("$.couch.js --- activeTasks");
    ...
    //console.log("$.couch.js --- session:");
    
      options = options || {};
      //console.log("GET  " + this.urlPrefix + "/_session");
      $.ajax({
    ...
    //console.log("$.couch.js --- userDb");

      $.couch.session({
        success : function(resp) {
        //console.log("$.couch.session --- success");
    ...
    ////console.log("$.couch.js --- prepareUserDoc");
    ...
    //console.log("$.couch.js --- login");
    
      options = options || {};
      //console.log("POST  " + this.urlPrefix + "/_session" + "name: " + options.name + "pass:" + options.password);
    ...
    //console.log("$.couch.js --- logout");
    
      options = options || {};
      //console.log("DELETE  " + this.urlPrefix + "/_session" + "username: _ password: _" );
    ...
    db: function(name, db_opts) {
      ...
      return /** @lends $.couch.db */{
        ...
        //console.log("$.couch.js --- db:create");
        ...
        //console.log("$.couch.js --- db:changes");
          ...
          //console.log("$.couch.js --- db:changes->triggerListeners");
          ...
          //console.log("$.couch.js --- db:changes->triggerListeners:success");
            timeout = 100;
            if (active) {
              since = resp.last_seq;
          ...
          //console.log("$.couch.js --- db:changes->triggerListeners:error");
        ...
        //console.log("$.couch.js --- db:allDocs");
        ...
        //console.log("$.couch.js --- db:allDesignDocs");
        ...
        //console.log("$.couch.js --- db:allApps");
        ...
        //console.log("$.couch.js --- db:openDoc");
        ...
        console.log("$.couch.js --- db:saveDoc");
          ...
          console.log(method + uri + encodeOptions(options) + toJSON(doc));
        ...
        //console.log("$.couch.js --- db:bulkSave");
        ...
        //console.log("$.couch.js --- db:removeDoc");
        ...
        //console.log("$.couch.js --- db:bulkRemove");
        ...
        //console.log("$.couch.js --- db:copyDoc");
        ...
        //console.log("$.couch.js --- db:getDbProperty");
        ...
        //console.log("$.couch.js --- db:setDbProperty");
    ...
    //console.log("$.couch.js --- replicate");
    
      repOpts = $.extend({source: source, target: target}, repOpts);
      if (repOpts.continuous && !repOpts.cancel) {
        ajaxOptions.successStatus = 202;
      }
      //console.log("POST  " + this.urlPrefix + "/_replicate");
  ...
  function fullCommit(options) {
    //console.log("$.couch.js --- fullCommit");
  ...
  function encodeOptions(options) {
    //console.log("$.couch.js --- encodeOptions");
